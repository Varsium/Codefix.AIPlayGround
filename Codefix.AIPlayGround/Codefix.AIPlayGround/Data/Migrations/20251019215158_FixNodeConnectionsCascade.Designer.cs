...
namespace Codefix.AIPlayGround.Migrations
{
    ...
    [Migration("20251019215158_FixNodeConnectionsCascade")]
    partial class FixNodeConnectionsCascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.FlowAgentEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("FlowId", "AgentId")
                        .IsUnique();

                    b.ToTable("FlowAgents");
                });

            modelBuilder.Entity("Codefix.AIPlayGround.Models.FlowEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ParentFlowId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.FlowExecutionEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.FlowNodeEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("FlowSpecificConfigurationJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("FlowId", "NodeId")
                        .IsUnique();

                    b.ToTable("FlowNodes");
                });

            modelBuilder.Entity("Codefix.AIPlayGround.Models.NodeConnectionEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.NodeEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.NodeTemplateEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("DefaultInputSchemaJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DefaultOutputSchemaJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.FlowAgentEntity", b =>
                {
                    ...
                    b.HasOne("Codefix.AIPlayGround.Models.FlowEntity", "Flow")
                        .WithMany("FlowAgents")
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.FlowEntity", b =>
                {
                    b.HasOne("Codefix.AIPlayGround.Models.FlowEntity", "ParentFlow")
                        .WithMany("SubFlows")
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.FlowNodeEntity", b =>
                {
                    ...
                    b.HasOne("Codefix.AIPlayGround.Models.NodeEntity", "Node")
                        .WithMany("FlowNodes")
            ...
            modelBuilder.Entity("Codefix.AIPlayGround.Models.NodeConnectionEntity", b =>
                {
                    b.HasOne("Codefix.AIPlayGround.Models.NodeEntity", "SourceNode")
                        .WithMany("SourceConnections")
                        .HasForeignKey("SourceNodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Codefix.AIPlayGround.Models.NodeEntity", "TargetNode")
